...
const getPosts = async (req, res, next) => {
    try {
        ...
        .populate("file").populate("category").populate("updatedBy", "-password -verificationCode -forgotPasswordCode");
...
const getSinglePost = async (req, res, next) => {
    try {
        ...
        res.status(200).json({code: 200, status: true, message: "Get post details successfully", data: {post}});
    } catch (error) {
        next(error);
    }
}

module.exports = {addPost, updatePost, deletePost, getPosts, getSinglePost};